      ...
      <section className="gradient-hero hero-pattern text-primary-foreground relative overflow-hidden">
        ...
        <div className="container py-5 sm:py-8 relative">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-accent text-xs uppercase tracking-[0.2em] font-medium">Dashboard</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-1">Account Overview</h1>
